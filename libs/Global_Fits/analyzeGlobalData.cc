...
//  double maxRange[6]={20,3,20,20,1,4};
  // These are for
    ...
    double variable[6] = {6.702,9.614,4.418,6.042,0.107,0.475};
  ...
  //double errorDefs[3] = {1, 0.95, 0.993};
  ...
  for (int i=0;i<3; i++) {
    ...
    /* minimum -> GetMinosError(2, errorLow, errorUp, 1);
    cout << errorUp << endl;
    minimum -> GetMinosError(3, errorLow, errorUp, 1);
    cout << errorUp << endl;
 */
